...
class Dashboard(Module):
    ...
    def _build_tables(self):
        f = tk.Frame(self._sc, bg=T.c["bg1"], padx=22, pady=0)
...
class Contacts(Module):
    ...
    def build(self):
        ...
        wrap = tk.Frame(self, bg=T.c["bg1"], padx=22, pady=0)
...
class Finance(Module):
    ...
    def build(self):
        ...
        wrap = tk.Frame(sc, bg=T.c["bg1"], padx=22, pady=0)
        wrap.pack(fill="both", expand=True)
        cols = [
...
class Settings(Module):
    ...
    def _section(self, p, title):
        tk.Frame(p, bg=T.c["sep"], height=1).pack(fill="x", pady=0)
